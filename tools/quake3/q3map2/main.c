...
int main( int argc, char **argv ){
...
#if GDEF_OS_WINDOWS
	/* Enable ANSI escape code processing (strikethrough, colours, etc.)
	   Windows consoles default to legacy mode; without this call the
	   escape sequences print as raw text instead of being interpreted. */
	{
	...
	/* Status notice: upstream deprecation context + our revival. */
	Sys_Printf( "I ASSURE YOU WE ARE WORKING (FOR JA ANYWAYS)\n" );
	Sys_Printf( "Note: Deprecated for Unvanquished 0.54.0 on 2023-01-29 -- nav mesh moved in-game; output is incompatible with Unvanquished.\n" );
	Sys_Printf( "      Resurrected for Jedi Academy navmesh generation, April 2026.\n" );
